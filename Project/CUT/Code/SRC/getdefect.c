...
void checkValidity(defect *defect_arr, char *str)
{
    ...
    s = str; // Copy input str into separate string s
    ...
    while (token != NULL)
    {
        ...
        {
        case 1:
            defect_arr->defectID = (char *)calloc(sizeof(token), sizeof(char));
            defect_arr->defectID = token;
            break;
        case 2:
            defect_arr->description = (char *)calloc(sizeof(token), sizeof(char));
            defect_arr->description = token;
            break;
        case 3:
            defect_arr->moduleName = (char *)calloc(sizeof(token), sizeof(char));
            defect_arr->moduleName = token;
            break;
        case 4:
            defect_arr->functionalArea = (char *)calloc(sizeof(token), sizeof(char));
            defect_arr->functionalArea = token;
            break;
        case 5:
            defect_arr->date = (char *)calloc(sizeof(token), sizeof(char));
            defect_arr->date = token;
            break;
        case 6:
            defect_arr->status = (char *)calloc(sizeof(token), sizeof(char));
            defect_arr->status = token;
            break;
        case 7:
            defect_arr->type = (char *)calloc(sizeof(token), sizeof(char));
            defect_arr->type = token;
            break;
        default:
            break;
        }
